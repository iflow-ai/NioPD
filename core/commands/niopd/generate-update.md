...
-   The script will generate a filename following the new naming convention: `[YYYYMMDD]-[initiative-name]-stakeholder-update-v1.md`.
...
-   Pass the initiative slug, initiative name, and generated update content as arguments to the script.
...
-   Provide the path to the file: "You can view it here: `niopd-workspace/reports/[YYYYMMDD]-[initiative-name]-stakeholder-update-v1.md`"
